...
wget -c -O /opt/flare/flare-host.sh https://raw.githubusercontent.com/flare-containers/flare-push-test/flare-host.sh
wget -c -O /opt/flare/flare-container.sh https://raw.githubusercontent.com/flare-containers/flare-push-test/flare-container.sh
